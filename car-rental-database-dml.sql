...
((select branch_id from branches where city like 'Seattle'), 'Matthew', 'Martinez', '1990-04-28', '78 Pike St', 'Seattle', 'WA', 'matthew.martinez@example.com', 63000.00),
((select branch_id from branches where city like 'Seattle'), 'Olivia', 'Taylor', '1988-11-15', '11 Bell St', 'Seattle', 'WA', 'olivia.taylor@example.com', 57000.00),
...
((select branch_id from branches where city like 'Seattle'), 'James', 'Lopez', '1995-03-18', '314 Summit Ave', 'Seattle', 'WA', 'james.lopez@example.com', 52000.00),
...
((select branch_id from branches where city like 'Seattle'), 'Emma', 'Barnes', '1986-06-25', '2223 Cherry St', 'Seattle', 'WA', 'emma.barnes@example.com', 54000.00),
...
((select branch_id from branches where city like 'Seattle'), 'Elijah', 'Kelly', '1994-01-28', '494 Elm St', 'Seattle', 'WA', 'elijah.kelly@example.com', 52000.00),
...
((select branch_id from branches where city like 'Seattle'), 'Lucas', 'Russell', '1993-04-19', '435 Fir St', 'Seattle', 'WA', 'lucas.russell@example.com', 59000.00);

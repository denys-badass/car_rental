...
((SELECT car_type_id FROM car_types WHERE car_type = 'Econom'), '799-XYF', 'JH4KA3260KC007360', 'Kia', 'Rio', '2020-01-01', 'Black', 5, 'Gasoline', 'Manual', 27852, TRUE, 5),
((SELECT car_type_id FROM car_types WHERE car_type = 'Econom'), 'D36-8BN', '1HGCM82633A004352', 'Ford', 'Fiesta', '2019-01-01', 'White', 5, 'Diesel', 'Automatic', 54312, TRUE, 2),
((SELECT car_type_id FROM car_types WHERE car_type = 'Econom'), 'H37-XY2', '1FAFP4041WF067316', 'Chevrolet', 'Spark', '2022-01-01', 'Red', 5, 'Electro', 'Automatic', 20484, TRUE, 1),
((SELECT car_type_id FROM car_types WHERE car_type = 'Standard'), 'B57-XY9', '1HGEM115XSL060792', 'Toyota', 'Corolla', '2023-01-01', 'Blue', 5, 'Hybrid', 'Automatic', 14015, TRUE, 3),
((SELECT car_type_id FROM car_types WHERE car_type = 'Standard'), 'G98-ZY3', '1G8AJ52F73Z164200', 'Honda', 'Civic', '2018-01-01', 'Grey', 5, 'Gasoline', 'Automatic', 91743, FALSE, 3),
((SELECT car_type_id FROM car_types WHERE car_type = 'Standard'), 'J88-9YH', '1N4AL11D75C109151', 'Ford', 'Transit', '2021-01-01', 'Blue', 12, 'Diesel', 'Manual', 125837, FALSE, 4),
((SELECT car_type_id FROM car_types WHERE car_type = 'Standard'), 'L90-3GJ', '1GNEK13ZX3R298984', 'Dodge', 'Journey', '2020-01-01', 'Black', 7, 'Diesel', 'Automatic', 46592, TRUE, 2),
((SELECT car_type_id FROM car_types WHERE car_type = 'Business'), 'W34-EF9', '2G1WF52E459279731', 'BMW', '3 Series', '2019-01-01', 'Green', 5, 'Diesel', 'Automatic', 68127, FALSE, 5),
((SELECT car_type_id FROM car_types WHERE car_type = 'Business'), 'Q65-4RF', '2C3KA43R08H129984', 'Mercedes', 'C-Class', '2022-01-01', 'Silver', 5, 'Diesel', 'Automatic', 30258, FALSE, 1),
((SELECT car_type_id FROM car_types WHERE car_type = 'Business'), 'R22-VB6', '19UUA5661DA707070', 'Audi', 'A4', '2021-01-01', 'Red', 5, 'Diesel', 'Automatic', 87546, TRUE, 3),
((SELECT car_type_id FROM car_types WHERE car_type = 'Business'), 'S39-6GH', '1FAHP3FN0BW146623', 'Lexus', 'IS', '2019-01-01', 'White', 5, 'Hybrid', 'Automatic', 46035, TRUE, 1),
((SELECT car_type_id FROM car_types WHERE car_type = 'Business'), 'U44-JK7', '3VWFE21C04M000001', 'Infiniti', 'Q50', '2023-01-01', 'Black', 5, 'Diesel', 'Automatic', 61259, TRUE, 3),
((SELECT car_type_id FROM car_types WHERE car_type = 'Premium'), 'V55-KL8', '5N1AR18U65C768122', 'Tesla', 'Model S', '2020-01-01', 'Grey', 5, 'Electro', 'Automatic', 10734, TRUE, 4),
((SELECT car_type_id FROM car_types WHERE car_type = 'Premium'), 'X66-MN4', '1N4AB41D1VC759373', 'Porsche', 'Panamera', '2021-01-01', 'Blue', 5, 'Gasoline', 'Automatic', 21025, TRUE, 2),
((SELECT car_type_id FROM car_types WHERE car_type = 'Premium'), 'Y77-OP5', '1LNHM81WXYV411972', 'Jaguar', 'XE', '2022-01-01', 'Silver', 5, 'Diesel', 'Automatic', 10512, TRUE, 1),
((SELECT car_type_id FROM car_types WHERE car_type = 'Premium'), 'Z88-QQ6', '2FTRX18L1XCA01234', 'BMW', '5 Series', '2019-01-01', 'Red', 5, 'Gasoline', 'Manual', 30501, TRUE, 3),
((SELECT car_type_id FROM car_types WHERE car_type = 'Premium'), 'A99-RR7', '1B3ES26C75D164896', 'Mercedes', 'S-Class', '2021-01-01', 'White', 5, 'Gasoline', 'Automatic', 41070, TRUE, 3),
...
VALUES
(1, 1, '2024-01-05', '2024-01-10', 37867, 39042, 1, 1), --1
(1, 2, '2024-01-15', '2024-01-20', 39042, 41073, 1, 1), --2
(2, 3, '2024-01-03', '2024-01-08', 25460, 27082, 1, 1), --3
(3, 4, '2024-01-12', '2024-01-15', 50112, 53024, 2, 5), --4
(3, 1, '2024-01-18', '2024-01-28', 53024, 54012, 5, 2), --5
(4, 5, '2024-01-07', '2024-01-12', 18930, 20034, 2, 4), --6
(5, 6, '2024-01-10', '2024-01-15', 12028, 13058, 3, 3), --7
(6, 7, '2024-01-20', '2024-01-25', 89641, 91743, 1, 3), --8
(7, 8, '2024-01-02', '2024-01-12', 123901, 125837, 5, 4), --9
